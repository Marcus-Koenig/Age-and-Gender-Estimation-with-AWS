...
const DROPDOWN_API_ENDPOINT = ''; // ToDo: Fill in the API of your dropdown lambda function
const ML_API_ENDPOINT = ''; // ToDo: Fill in the inferencing lambda function
  ...
  return (
    <div className="App">
      ...
      <div className="Output">
        <h2>Results</h2>
        <img src={outputFileData} alt="" width="80%" height="auto" /> 
      </div>
    </div>
  );
}
